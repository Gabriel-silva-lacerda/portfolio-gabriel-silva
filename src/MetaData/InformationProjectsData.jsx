...
export const informations = [
  {
    ...
    urlIconAxios: Axios,
    urlIconReactQuery: ReactQuery,
    urlIconJavaScript: ReactIcon,
    linkProject: "https://desafio-mks-frontend-challenge.vercel.app/",
    linkRepository:
      "https://github.com/Gabriel-silva-lacerda/desafio-mks-frontend-challenge",
    altProject: "Projeto carrinho de compras",
    altIconTypescript: "imagem icon typescript",
    altCss: "imagem icon styled components",
    alrIconAxios: "imagem icon axios",
